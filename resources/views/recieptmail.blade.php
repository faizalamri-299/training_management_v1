...
<head>
    ...
    .paymentinfo td:not(:first-child){
  ...
  .invoice-box table tr.information .secondcolumn {
        text-align: left;
        padding-left:8%;
        width:30%;
    }
    .invoice-box table tr.information .firstcolumn {
        padding-right:8%;text-align: left;
        width:51%;
    }
...
<body >
    ...
    <table   class="invoice-header">
        <tr>
            ...
            <td class="bgGreen">
            <strong>OFFICIAL RECIEPT</strong>
            <div >
                <b>{{ $from }}</b><br>
                {!! $fromaddr !!}
    ...
    <table class="headerdtl"  cellpadding="0" cellspacing="0">
            <tr>
            <td align="right">Office Mobile No: {{ $fromtel }}</td>
            <td align="center" width="10%">Fax: - </td>
            <td align="left">Email: admin@holisticslab.my</td>
            </tr>
            </table>
            @php
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="information">
                <td colspan="3" >
               <p>RECEIVED THE SUM OF : <u>{{ $pricetext.strtoupper($f->format($pricenumber))." ONLY"}}</u>
               </p>
                </td>
            </tr>
            </table>
            ...
            <tr class="item last">
                <td>
                <p>PAYMENT <strong>{{$course}} </strong></p> 
         ...
         <table cellpadding="0" cellspacing="0">
            ...
            <tr class="information">
               ...
               @if ($chno)
               <br/>
               2) Validity of This Reciept is Subject to Clearing of Cheque
               @endif
                </td>
                <td>
                </td>
            ...
            <td>Inv. No</td>
            <td>Inv Date</td>
            <td align="right">Invoice Ammount</td>
            <td align="right">Paid Ammount</td>
